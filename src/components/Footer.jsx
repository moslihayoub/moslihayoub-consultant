    ...
    <footer style={styles.footer}>
      <div className="container" style={styles.container}>
        ...
        <div style={styles.links}>
          ...
          <a href="https://x.com/moslih84" target="_blank" rel="noreferrer" style={styles.iconLink} aria-label="X (Twitter)" className="hover-trigger">
            <TwitterIcon size={20} />
          </a>
          <a href="https://www.behance.net/moslih84" target="_blank" rel="noreferrer" style={styles.iconLink} aria-label="Behance" className="hover-trigger">
            <BehanceIcon size={20} />
          </a>
          <a href="https://www.youtube.com/@moslih84" target="_blank" rel="noreferrer" style={styles.iconLink} aria-label="YouTube" className="hover-trigger">
            <YoutubeIcon size={20} />
          </a>
          <a href="https://dribbble.com/moslih84" target="_blank" rel="noreferrer" style={styles.iconLink} aria-label="Dribbble" className="hover-trigger">
            <DribbbleIcon size={20} />
          </a>
          <a href="mailto:moslihayoub@gmail.com" style={styles.iconLink} aria-label="Email" className="hover-trigger">
            <MailIcon size={20} />
          </a>
        </div>
        <div style={styles.copy}>
          &copy; {new Date().getFullYear()} Ayoub MOSLIH. {t('footer_rights')}
        </div>
      </div>
    </footer>
  );
