            ...
            <motion.div style={{ flex: 1, display: 'flex', justifyContent: 'center', alignItems: 'center', minWidth: 0, width: '100%' }} initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.75, delay: 0.2, ease: 'easeOut' }}>
              <div className="hero-marquee-container">
                <div className="marquee-column" style={{ animationDuration: '30s' }}>
                  {[1, 2].map((loop) => (
                    <div key={loop} className="marquee-content">
                      <img src="/assets/galerie/20230517_184215.webp" alt="Portrait d'Ayoub MOSLIH en situation professionnelle" fetchPriority={loop === 1 ? "high" : "auto"} className="lightbox-media" onClick={() => openLightbox('image', '/assets/galerie/20230517_184215.webp')} />
                      <img src="/assets/galerie/20250419_155833.webp" alt="Photo d'Ayoub MOSLIH lors d'un événement ou présentation" className="lightbox-media" onClick={() => openLightbox('image', '/assets/galerie/20250419_155833.webp')} />
                      <img src="/assets/galerie/3_20250419_225936_0002.webp" alt="Ayoub MOSLIH animant un atelier ou une réunion" className="lightbox-media" onClick={() => openLightbox('image', '/assets/galerie/3_20250419_225936_0002.webp')} />
                      <img src="/assets/galerie/IMG-20230515-WA0022.webp" alt="Ayoub MOSLIH travaillant sur un projet digital" className="lightbox-media" onClick={() => openLightbox('image', '/assets/galerie/IMG-20230515-WA0022.webp')} />
                    </div>
                  ))}
                </div>
                <div className="marquee-column marquee-column-reverse" style={{ animationDuration: '35s', animationDelay: '-10s' }}>
                  {[1, 2].map((loop) => (
                    <div key={loop} className="marquee-content">
                      <img src="/assets/galerie/screenshot-18-45-54.webp" alt="Aperçu de l'interface utilisateur d'un projet web récent" className="lightbox-media" onClick={() => openLightbox('image', '/assets/galerie/screenshot-18-45-54.webp')} />
                      <img src="/assets/galerie/screenshot-18-46-30.webp" alt="Aperçu d'un design system ou maquette d'application" className="lightbox-media" onClick={() => openLightbox('image', '/assets/galerie/screenshot-18-46-30.webp')} />
                      <img src="/assets/galerie/screenshot-18-52-01.webp" alt="Aperçu d'une interface mobile ou tableau de bord" className="lightbox-media" onClick={() => openLightbox('image', '/assets/galerie/screenshot-18-52-01.webp')} />
                      <img src="/assets/galerie/447402561_1004591577261671_4782695626181526568_n.webp" alt="Photo d'Ayoub MOSLIH lors d'une session de consulting" className="lightbox-media" onClick={() => openLightbox('image', '/assets/galerie/447402561_1004591577261671_4782695626181526568_n.webp')} />
                    </div>
                  ))}
                </div>
              </div>
