...
import { Mail, Clock, CheckCircle2, Trash2, Search, MoreVertical } from 'lucide-react';
        ...
        <div style={{ display: 'flex', gap: '16px', alignItems: 'center', flexWrap: 'wrap' }}>
          <div style={{ position: 'relative', width: '300px', maxWidth: '100%' }}>
            ...
            <input 
              ...
              style={{ width: '100%', padding: '10px 10px 10px 40px', border: '1px solid #e2e8f0', borderRadius: '8px', boxSizing: 'border-box', outline: 'none' }}
            />
          </div>
          <ExportButton 
            data={filteredLeads} 
